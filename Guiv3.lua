...
local toastHolder = U.new(
	"Frame",
	{ Name = "Toasts", Size = UDim2.new(0, 300, 1, 0), Position = UDim2.new(1, -310, 0, 0), BackgroundTransparency = 1, Parent = gui },
	{
		U.new(
			"UIListLayout",
			{
...
local topBar = U.new(
	...
	{ Size = UDim2.new(1, 0, 0, 40), BackgroundColor3 = T.Surface, BorderSizePixel = 0, Parent = main },
	{
		...
		U.new(
			"Frame",
			{ Size = UDim2.new(1, 0, 0, 14), Position = UDim2.new(0, 0, 1, -14), BackgroundColor3 = T.Surface, BorderSizePixel = 0 }
		),
	}
)
U.new(
...
local sidebar = U.new(
	"Frame",
	{ Size = UDim2.new(0, 150, 1, -40), Position = UDim2.new(0, 0, 0, 40), BackgroundColor3 = T.Surface, BorderSizePixel = 0, Parent = main },
	{
		U.new(
			"UIPadding",
...
do
	...
	local function infoCard(label, init, col, order)
		local c = U.new(
			"Frame",
			{ Size = UDim2.new(0.32, -4, 1, 0), BackgroundColor3 = T.Card, BorderSizePixel = 0, LayoutOrder = order, Parent = infoRow },
			{
				U.new("UICorner", { CornerRadius = UDim.new(0, 8) }),
	...
	local scanBtns = U.new(
		"Frame",
		{ Size = UDim2.new(1, 0, 0, 30), Position = UDim2.new(0, 0, 1, -30), BackgroundTransparency = 1, Parent = scanCard },
		{
			U.new(
				"UIListLayout",
				{
...
do
	...
	local ag = U.new(
		...
		{ Size = UDim2.new(1, 0, 0, 220), BackgroundTransparency = 1, LayoutOrder = 4, Parent = pg },
		{
			U.new(
				"UIGridLayout",
				{ CellSize = UDim2.new(0, 120, 0, 32), CellPadding = UDim2.new(0, 6, 0, 6), SortOrder = Enum.SortOrder.LayoutOrder }
			),
		}
	)
	local pActs = {
...
do
	...
	local lg = U.new(
		...
		{ Size = UDim2.new(1, 0, 0, 70), BackgroundTransparency = 1, LayoutOrder = 2, Parent = pg },
		{
			U.new(
				"UIGridLayout",
				{ CellSize = UDim2.new(0, 110, 0, 30), CellPadding = UDim2.new(0, 6, 0, 6), SortOrder = Enum.SortOrder.LayoutOrder }
			),
		}
	)
	for i, sa in ipairs({
...
do
	...
	local acBtns = U.new(
		"Frame",
		{ Size = UDim2.new(1, 0, 0, 30), Position = UDim2.new(0, 0, 1, -30), BackgroundTransparency = 1, Parent = controlCard },
		{
			U.new(
				"UIListLayout",
				{
