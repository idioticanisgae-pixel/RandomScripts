...
ZukPretty    = _ppImpl
ZukClean     = _coImpl
end -- end decompiler block (~26 locals retired)
local hlLine
do -- syntax highlighter block
local Syntax = {
...
end -- end syntax highlighter block (~8 locals retired)
local ROW_H      = 17
local INDENT_PER = 14
...
end -- end GUI converter block (~9 locals retired)
...
-- GC panel overlays the leftCol when active
...
local function renderGCRows()
    ...
    for i, item in ipairs(gcFoundItems) do
        ...
        -- Decompile button (left side of row)
        ...
        if isScript then
            ...
            -- Inspect button (opens table inspector for ModuleScript, meta/upvalues for others)
            ...
            inBtn.MouseButton1Click:Connect(function()
                ...
                if item.cls == "ModuleScript" then
                    ...
                    -- LocalScript / Script: load upvalues + meta tab
                    inspState.rootTable  = nil
                    inspState.currentTbl = nil
                    inspState.pathStack  = {}
                    inspState.visitedSet = {}
            ...
            -- Non-script: single click to select
...
-- Add the "🔍 Hidden" button to the treeHeader
